package com.demo.postsql.springjpa.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.demo.postsql.springjpa.controllers"))
                .paths(PathSelectors.any()).build()
                .apiInfo(new ApiInfo("Spring JPA with PostgreSQL | Spring Boot Services", "A set of services for Demo", "1.0.0", null, null, null, null,
                        new ArrayList<>()))
